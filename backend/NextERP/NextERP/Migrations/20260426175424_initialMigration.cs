        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionCategory = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "SystemSettings"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "PreferNotToSay"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefreshTokens", x => x.RefreshTokeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_IsRevoked_ExpiryDate",
                table: "RefreshTokens",
                columns: new[] { "IsRevoked", "ExpiryDate" });
